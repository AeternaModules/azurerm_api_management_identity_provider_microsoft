output "api_management_identity_provider_microsofts_id" {
  ...
  value       = { for k, v in azurerm_api_management_identity_provider_microsoft.api_management_identity_provider_microsofts : k => v.id if v.id != null && length(v.id) > 0 }
}
output "api_management_identity_provider_microsofts_api_management_name" {
  ...
  value       = { for k, v in azurerm_api_management_identity_provider_microsoft.api_management_identity_provider_microsofts : k => v.api_management_name if v.api_management_name != null && length(v.api_management_name) > 0 }
}
output "api_management_identity_provider_microsofts_client_id" {
  ...
  value       = { for k, v in azurerm_api_management_identity_provider_microsoft.api_management_identity_provider_microsofts : k => v.client_id if v.client_id != null && length(v.client_id) > 0 }
}
output "api_management_identity_provider_microsofts_client_secret" {
  ...
  value       = { for k, v in azurerm_api_management_identity_provider_microsoft.api_management_identity_provider_microsofts : k => v.client_secret if v.client_secret != null && length(v.client_secret) > 0 }
  sensitive   = true
}
output "api_management_identity_provider_microsofts_resource_group_name" {
  ...
  value       = { for k, v in azurerm_api_management_identity_provider_microsoft.api_management_identity_provider_microsofts : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
